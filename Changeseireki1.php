...
if($_POST["month"]>=1 && $_POST["month"]<=12){
	...
	$coremonth="月が正しくない数値です。1から12の間の数値を入力してください。<br>\n";
     }
if($_POST["day"]>=1 && $_POST["day"]<=31){
	$coreday=$_POST["day"]."日です。<br>\n";
}else{ 
	$coreday="日が正しくない数値です。1から31の間の数値を入力してください。<br>\n";
}
if($_POST["number"]>=2022){
   $seireki="まだ暦が始まっていません。<br>\n";
}
	elseif($_POST["number"]>=2019){
...
<html>
	...
	<body>
		<!--<form action="Changeseireki1.html" method="post">
			西暦を4桁で入力してください。<br>
